    ...
    return (
        <form className="w-full flex flex-col gap-8 bg-gray-800 p-6">
            ...
            <div className="flex flex-col items-start w-full gap-6">
                ...
                <button className="bg-purple-600 text-gray-200 py-2 px-6 rounded-sm border-none outline-none text-sm hover:bg-gray-200 hover:text-purple-600">Add Topic</button>
            </div>
        </form>
    )
}